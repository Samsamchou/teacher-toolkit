  ...
  return (
    <section className="step-page result-page" aria-labelledby="step-four-title">
      <div className="step-intro result-intro">
        ...
        <p>You made your worry visible. / 你把自己的煩惱變得看得見了。</p>
      </div>
      ...
      <div className="result-grid">
        ...
        <section className="prompt-card" aria-labelledby="prompt-title">
          ...
          <p className="prompt-help">Copy this English prompt into an image tool later. / 之後可以把這段英文提示詞貼到圖像工具。</p>
          ...
          <div className="prompt-actions">
            ...
            {copyStatus === 'failed' ? <span className="copy-status" role="status">Please select the text and copy it. / 請選取文字後複製。</span> : null}
          </div>
        </section>
      </div>
      ...
      <div className="privacy-note result-privacy">
        ...
        <div>
          <strong>Your feelings are yours.</strong>
          <span>You can create your monster without showing it to everyone. / 你可以創作自己的怪獸，不必把它展示給所有人。</span>
        </div>
      </div>
