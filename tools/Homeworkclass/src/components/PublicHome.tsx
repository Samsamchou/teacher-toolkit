...
import { CLASSES } from "../data/semester";
  ...
  return (
    <div className="public-home">
      <header className="public-header">
        <a className="brand" href="#top" aria-label="英語作業與課堂紀錄首頁">
          <span className="brand__mark" aria-hidden="true">好</span>
          <span>
            <strong>英語作業與課堂紀錄</strong>
            <small>Homework & Class Notes</small>
          </span>
        </a>
        ...
        <section className="hero-section">
          <div className="hero-copy">
            ...
            <p className="hero-lead">
              以 20 節週課表快速登記英語、在地與國際歌謠課程，集中掌握八個班級的作業與課堂情況。
            </p>
            ...
            <div className="preview-window">
              ...
              <div className="preview-lessons">
                {[
                  ...
                  ["六甲", "英語", "11:20"],
                  ["五甲", "英語", "14:20"],
                ].map(([classId, subject, time], index) => {
                  const meta = CLASSES[classId as keyof typeof CLASSES];
                  return (
                    <div className="preview-lesson" key={`${classId}-${time}`} style={{ "--accent": meta.accent } as CSSProperties}>
                      <span className="preview-lesson__number">{index + 2}</span>
                      <span><strong>{classId}・{subject}</strong><small>{time} 開始</small></span>
              ...
              <div className="preview-summary">
                ...
                <span><strong>20</strong><small>每週課次</small></span>
              </div>
            </div>
      ...
      <footer className="public-footer">
        <strong>英語作業與課堂紀錄</strong>
        <span>115 學年度第一學期・Asia/Taipei</span>
      </footer>
