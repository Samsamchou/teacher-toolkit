...
telemetry:
  ...
  revisions: 3
downstream: self
supersedes: RDQ-spec-hwg7-u01-lesson1-20260817-r2.md
---

# RDQ 需求規格：HWG7 Unit 1 第一節課

## 確認紀錄
- 教師於 2026-08-17 確認：題庫同步保存為 Markdown 審核稿及 JSON 網站資料檔，兩者執行一致性檢查，並依本規格開始製作。
...
- 題庫同步保存為 Markdown 審核稿與 JSON 網站資料檔，兩者由同一份規格內容建立並執行一致性檢查。
