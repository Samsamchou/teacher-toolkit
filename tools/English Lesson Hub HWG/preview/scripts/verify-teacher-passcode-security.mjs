...
const [source, firebaseJson, rules, functionSource, functionConfig, webClient, publicConfigHelper, main] = await Promise.all([
...
if (functionSource.includes("createCustomToken") || functionSource.includes("getAuth")) errors.push("Results Functions must not mint custom tokens.");
