...
| `202609 在地課程4年級上學期教案` | 23 | 〈扇形車庫〉來源追溯、2 節骨架、第 1 節新舊可比較詳案、影片 Kahoot 草稿、教師暫停提示 Word、官方範本匯入 XLSX、5 張無文字圖片及可重建／QA 腳本 |

2026-08-25 起，〈扇形車庫〉調整成果另存在 `202609 在地課程4年級上學期教案`，不覆寫原本的 20 節 Word 基線。第 1 節已完成教案樣稿與教材；第 2 節尚未展開詳案及教材。
...
1. 舊的 `01_第1-2週_扇形車庫 教材` 資料夾仍空白；第 1 節新教材已另存在 `202609 在地課程4年級上學期教案`，第 2 節詳案與教材尚未製作。
...
2. 教師審閱〈扇形車庫〉第 1 節教案與教材後，再依相同追溯鏈展開第 2 節詳案及教材。
