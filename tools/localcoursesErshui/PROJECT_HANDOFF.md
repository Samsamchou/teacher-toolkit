...
| `202609 在地課程4年級上學期教案` | 435 | 四個正式單元、20個節次資料夾及上層索引；〈扇形車庫〉兩節成果已分流，其他18節各以README標示尚未開始 |

2026-08-25 起的新分析與教材集中在 `202609 在地課程4年級上學期教案`；2026-08-26 起依四個正式單元、週次及節次分類。〈扇形車庫〉成果位於 `202609 在地課程4年級上學期教案\扇形車庫 第1-2週`，第1節與第2節分別存入 `01_第1節`、`02_第2節`，不覆寫原本的20節Word基線。第2節已完成四階段詳案、七類教材草圖、學生版與教師答案版各7頁的正式數位教材、PDF、逐頁PNG及QA紀錄；實體試印仍為教師端待辦。
...
1. 舊的 `01_第1-2週_扇形車庫 教材` 資料夾仍空白；新成果均位於 `202609 在地課程4年級上學期教案\扇形車庫 第1-2週`。第2節正式數位教材已通過QA，但學生版與教師答案版PDF仍需教師實體試印。
...
2. 教師實體試印〈扇形車庫〉第2節學生版與教師答案版PDF；若紙本可讀性正常，即可直接使用，若有列印偏移再依保存的可重建來源修正。
