...
- `202609 在地課程4年級上學期教案` 的新增與修訂成果依正式單元存入 `扇形車庫 第1-2週`、`坐火車趣集集 第3-10週`、`閱覽鐵道風華 第11-14週`、`介紹五分車與認識小火車鐵道 第15-20週`；不要把單元檔案散放在上層。
- 每個正式單元有幾節課，就在單元資料夾建立幾個 `01_第1節`、`02_第2節`……節次資料夾；各節的詳案、教材、QA、歷史版本與重建工具均歸入對應節次，共用的來源追溯、單元骨架與單元索引才留在單元根目錄。尚未開始的節次以簡短 `README.md` 標示，讓 GitHub 保留資料夾。
