...
http.createServer(async(req,res)=>{
 ...
 }catch(e){res.writeHead(e instanceof ActivityError?e.status:503);res.end(JSON.stringify({message:e instanceof ActivityError?e.message:'Local service unavailable. Please retry.',code:e instanceof ActivityError?e.code:'SERVICE_UNAVAILABLE'}));if(!(e instanceof ActivityError))console.error('Local activity failure:',e.code||e.name);}
